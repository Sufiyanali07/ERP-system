...
// Middleware
app.use(cors({
    origin: ['http://localhost:3000', 'http://192.168.1.5:3000', 'http://192.168.1.3:3000'],
    credentials: true
}));
...
// Connect to MongoDB
mongoose.connect('mongodb+srv://sufiyanali0727:erp1234@cluster0.o7uq2of.mongodb.net/erp_system?retryWrites=true&w=majority')
.then(() => {
