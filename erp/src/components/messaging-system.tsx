...
export default function MessagingSystem() {
  ...
  const fetchMessages = useCallback(async (type: 'received' | 'sent' = 'received') => {
    try {
      ...
      const response = await fetch(`https://erp-system-rose.vercel.app/api/messages?type=${type}&search=${searchTerm}`, {
        headers: {
  ...
  const fetchContacts = useCallback(async () => {
    try {
      ...
      const response = await fetch('https://erp-system-rose.vercel.app/api/messages/users/contacts', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      const response = await fetch('https://erp-system-rose.vercel.app/api/messages/stats/overview', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const sendMessage = async () => {
    try {
      ...
      const response = await fetch('https://erp-system-rose.vercel.app/api/messages', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const markAsRead = async (messageId: string) => {
    try {
      ...
      await fetch(`https://erp-system-rose.vercel.app/api/messages/${messageId}/read`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
